...
function getWeekendDates() {
  ...
  return {
    dates: [fmt(friday), fmt(saturday), fmt(sunday)],
...
function WeekendPage() {
    ...
    return (
      <section className="mb-12">
        <div className="mb-6">
          ...
          <h2 className="text-xl font-bold text-gray-900">{formatFull(date)}</h2>
  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="bg-gray-900 py-14 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-400 text-sm font-medium uppercase tracking-widest mb-3">Rockwall, TX</p>
          <h1 className="text-4xl font-bold text-white mb-3">This Weekend</h1>
          <p className="text-gray-300 text-lg">{weekendLabel}</p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-gray-600 text-xl font-medium mb-2">Nothing listed yet for this weekend</p>
            <p className="text-gray-400 text-sm mb-8">Check back soon or browse all upcoming events on the calendar.</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-100 flex flex-col sm:flex-row gap-3 justify-center">
          <Link to="/calendar" className="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg text-sm font-medium hover:border-gray-500 hover:text-gray-900 transition text-center">
            View Full Calendar
          </Link>
          <Link to="/" className="border border-gray-300 text-gray-700 px-6 py-3 rounded-lg text-sm font-medium hover:border-gray-500 hover:text-gray-900 transition text-center">
            Back to Home
          </Link>
        </div>
