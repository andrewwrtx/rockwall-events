...
function Home() {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="bg-gray-900 py-12 md:py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="relative max-w-xl mx-auto mb-5">
            <input
              ...
              className="w-full bg-white text-gray-900 placeholder-gray-400 px-4 py-3 md:px-5 md:py-4 rounded-xl text-sm md:text-base focus:outline-none shadow-lg"
            />
            {searchQuery && (
              <button
          ...
          {!isSearching && (
            <div className="flex flex-col sm:flex-row gap-2 justify-center">
              <a href="#events" className="bg-white text-gray-900 font-semibold px-5 py-2.5 rounded-lg hover:bg-gray-100 transition text-sm">
                Browse Events
              </a>
              <Link to="/weekend" className="border border-gray-600 text-gray-300 font-semibold px-5 py-2.5 rounded-lg hover:border-gray-400 hover:text-white transition text-sm">
                This Weekend
              </Link>
              <Link to="/submit" className="border border-gray-600 text-gray-300 font-semibold px-5 py-2.5 rounded-lg hover:border-gray-400 hover:text-white transition text-sm">
                Submit an Event
              </Link>
            </div>
          )}
      ...
      {!isSearching && (
        <div className="max-w-6xl mx-auto px-4 py-8 md:py-12">
          ...
          <section className="mb-10">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-3">Browse by Category</p>
              ...
              {categories.map(function(cat) {
                return (
                  <Link
                    key={cat.id}
                    to={'/category/' + cat.id}
                    className="flex items-center gap-2 border border-gray-200 rounded-full px-3 py-1.5 hover:border-gray-400 transition group"
                  >
          ...
          <section id="events">
            ...
            {loading ? (
              ...
              <div className="text-center py-12 text-gray-400">No upcoming events — check back soon!</div>
            ) : (
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
