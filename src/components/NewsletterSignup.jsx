          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="bg-gray-800 border border-gray-700 text-white placeholder-gray-500 px-4 py-2.5 rounded-lg text-sm focus:outline-none focus:border-gray-500 w-full sm:w-32"
              />
              <input
                type="email"
                value={email}
                ...
                className="bg-gray-800 border border-gray-700 text-white placeholder-gray-500 px-4 py-2.5 rounded-lg text-sm focus:outline-none focus:border-gray-500 flex-1"
              />
              <button
                onClick={handleSubmit}
                disabled={status === 'loading'}
                className="bg-white text-gray-900 font-semibold px-5 py-2.5 rounded-lg text-sm hover:bg-gray-100 transition disabled:opacity-50 whitespace-nowrap"
              >
